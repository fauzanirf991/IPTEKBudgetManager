...
public class asetList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener = new asetAdapter.RecyclerViewClickListener(){
            ...
            public void onRowClick(View view, final int position){
                Intent intent = new Intent(asetList.this, asetEditor.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(asetList.this, asetEditor.class));
            }
        });
    ...
    public void getAset(){
        ...
        call.enqueue(new Callback<List<aset>>() {
            ...
            public void onResponse(Call<List<aset>> call, Response<List<aset>> response) {
                ...
                adapter = new asetAdapter(asetlist, asetList.this, listener);
            ...
            public void onFailure(Call<List<aset>> call, Throwable t) {
                Toast.makeText(asetList.this, "error :"+
